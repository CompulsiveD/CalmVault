...
> **Tip:** Each activity's deployment creates resources with an auto-generated 4-character `SUFFIX` unique to your subscription. You'll capture it from the deployment output in Activity 1.2 and reuse it throughout the lab.
